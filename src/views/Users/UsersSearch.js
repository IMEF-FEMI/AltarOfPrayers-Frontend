...
function UsersSearch(props) {
  const { rowsPerPage, searchList, userCount } = props.users;
  ...
  const emptyRows =
    rowsPerPage - Math.min(rowsPerPage, searchList.length - page * rowsPerPage);
...
export default connect(mapStateToProps, mapActionsToProps)(UsersSearch);
